...
export const help: Record<string, string> = {
  ...
  promptTemplate: "Sent on every routine. Keep this small and dynamic. Use it for current-task framing, not large static instructions. Supports {{ agent.id }}, {{ agent.name }}, {{ agent.role }} and other template variables.",
  ...
  workspaceStrategy: "How Paperclip should realize an execution workspace for this agent. Keep project_primary for normal cwd execution, or use git_worktree for research-task-scoped isolated checkouts.",
  ...
  maxTurnsPerRun: "Maximum number of agentic turns (tool calls) per routine run.",
  ...
  bootstrapPrompt: "Only sent when Paperclip starts a fresh session. Use this for stable setup guidance that should not be repeated on every routine.",
  ...
  intervalSec: "Seconds between automatic routine invocations.",
  ...
  cooldownSec: "Minimum seconds between consecutive routine runs.",
  maxConcurrentRuns: "Maximum number of routine runs that can execute simultaneously for this agent.",
