...
export function IssueRelatedWorkPanel({
  ...
  return (
    <div className="space-y-3">
      <Section
        title="References"
        description="Other tasks this research task currently points at in its title, description, comments, or documents."
        items={outbound}
        emptyLabel="This research task does not reference any other tasks yet."
      />
      <Section
        title="Referenced by"
        description="Other tasks that currently point at this research task."
        items={inbound}
        emptyLabel="No other tasks reference this research task yet."
      />
    </div>
  );
}
