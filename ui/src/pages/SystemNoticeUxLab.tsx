...
const checklist = [
  ...
  "Research task, agent, and run metadata render as typed link rows, not raw markdown",
      ...
      >
        <div className="space-y-4 rounded-2xl border border-border/70 bg-background/70 p-4">
          <MockUserBubble
            ...
            body="Why does this research task keep waking back up without a clear next step?"
            alignEnd
          />
          <MockAgentBubble
          ...
          <SystemNotice
            ...
            body="Paperclip could not resolve this research task's missing disposition automatically. The research task is blocked on a recovery owner."
            metadata={[
              {
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="min-w-0">
                        ...
                        <ul className="mt-1.5 list-disc space-y-0.5 pl-4 text-[13px] leading-5">
                          <li>Source research task: PAP-3440</li>
