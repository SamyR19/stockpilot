  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1.5">
            <h2 className="text-sm font-semibold">Research Task Plan Decomposition Panel</h2>
            <p className="max-w-2xl text-sm text-muted-foreground">
              Show accepted-plan decomposition history on research task detail pages. Intended for debugging and validating
          ...
          <ToggleSwitch
            ...
            disabled={toggleMutation.isPending}
            aria-label="Toggle research task plan decomposition panel experimental setting"
          />
        </div>
      </section>
      ...
      <section className="rounded-xl border border-border bg-card p-5">
        <div className="flex flex-col gap-5">
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-1.5">
              <h2 className="text-sm font-semibold">Auto-Create Research Task Recovery Tasks</h2>
              <p className="max-w-2xl text-sm text-muted-foreground">
                Let the routine scheduler create recovery research tasks for research task dependency chains found inside the
            ...
            <ToggleSwitch
              ...
              aria-label="Toggle research task graph liveness auto-recovery"
            />
          </div>
