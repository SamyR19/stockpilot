      ...
      <div className="border-b border-border px-4 py-3 sm:px-6">
        ...
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search research tasks, comments, documents, agents, projects…"
  ...
  if (showInitialState) {
    return (
      <div className="mx-auto flex w-full max-w-2xl flex-col gap-4 px-4 py-10 sm:px-6">
        <div>
          <h2 className="text-lg font-semibold">Type to search workspace memory.</h2>
          <p className="mt-1 text-sm text-muted-foreground">
            Research tasks, comments, plan documents, agents, projects — same surface, ranked by relevance.
          </p>
        </div>
        ...
        <ul className="space-y-1 text-xs text-muted-foreground">
          <li>
            ...
            <code className="rounded bg-muted px-1 py-0.5 text-[11px]">PAP-123</code> to jump straight to a research task.
          </li>
          <li>
    ...
    return (
      <div className="mx-auto flex w-full max-w-xl flex-col items-center justify-center gap-3 px-4 py-12 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          you can retry or fall back to the Research Tasks filter.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-2">
          ...
          <Button onClick={navigateIssuesFallback} variant="outline" size="sm">
            Open Research Tasks filter view
          </Button>
        </div>
      </div>
    );
      ...
      <div className="mx-auto flex w-full max-w-xl flex-col items-center justify-center gap-3 px-4 py-12 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          ...
          <Button onClick={openNewIssue} size="sm" variant="default">
            ...
            Create research task from this query
          </Button>
