...
- ⏳ **N2. De-Paperclip the onboarding/agent framing** — remove "CEO/board/company" metaphors from first-run + agent creation; lean toward a single implicit personal workspace. (Bigger re-concept; relabel-then-rearchitect incrementally. The deep "company" tenancy rename stays deferred — see §7 rename.)
