...
- ⏳ **N1. Hire-an-Analyst flow** — finance-role agent creation (gallery of the 6 analyst personas: equity-analyst, news-sentinel, portfolio-manager, macro-researcher, quant-analyst, earnings-scout) that one-click creates an agent pre-wired with the matching skill; also verify/seed those finance skills into the installable catalog. Mirrors the routine-templates pattern. *(Highest-leverage: today you cannot easily create analysts.)*
